...
class Controller extends BaseController
{
    ...
    //Función que devuelve un bool si las contraseñas coinciden
    protected function checkLogin($email, $password)
    {
        ...
        if($emailSave == $email && Hash::check( $password, $passwordSave)) /*Contraseña introducida*/ /*Contraseña del usuario encontrado*/
        {
            return true;
        }
        return false;
    ...
    //Función que devuelve un bool si el mail recibido esta en la BBDD
    ...
    protected function getGlobalPath($saveRoute, $image){
        return env('APP_URL') . $saveRoute . $image;
    }
